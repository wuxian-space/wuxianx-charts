...
const __pageData = JSON.parse('{"title":"条形图","description":"","frontmatter":{},"headers":[],"relativePath":"zh/charts/bar-horizontal.md","filePath":"zh/charts/bar-horizontal.md","lastUpdated":1724294638000}');
const _sfc_main = { name: "zh/charts/bar-horizontal.md" };
const _hoisted_1 = /* @__PURE__ */ createBaseVNode("h1", {
  id: "条形图",
  tabindex: "-1"
}, [
  /* @__PURE__ */ createTextVNode("条形图 "),
  /* @__PURE__ */ createBaseVNode("a", {
    class: "header-anchor",
    href: "#条形图",
    "aria-label": 'Permalink to "条形图"'
  }, "​")
], -1);
