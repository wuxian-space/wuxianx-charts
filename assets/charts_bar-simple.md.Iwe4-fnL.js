...
const __pageData = JSON.parse('{"title":"Bar Simple","description":"","frontmatter":{},"headers":[],"relativePath":"charts/bar-simple.md","filePath":"charts/bar-simple.md"}');
const _sfc_main = { name: "charts/bar-simple.md" };
...
const _hoisted_4 = /* @__PURE__ */ createBaseVNode("p", null, "This is a grouped bar chart with customized colors and Echarts configuration.", -1);
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  const _component_bar_simple = resolveComponent("bar-simple", true);
  ...
  return openBlock(), createElementBlock("div", null, [
    ...
    createVNode(_component_demo, null, {
      component: withCtx(() => [
        createVNode(_component_bar_simple_configured)
      ]),
      default: withCtx(() => [
        _hoisted_4,
        _hoisted_5
...
const barSimple = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render]]);
export {
  __pageData,
  barSimple as default
};
