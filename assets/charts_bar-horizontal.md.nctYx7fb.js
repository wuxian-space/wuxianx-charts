...
const __pageData = JSON.parse('{"title":"Horizontal Bar Chart","description":"","frontmatter":{},"headers":[],"relativePath":"charts/bar-horizontal.md","filePath":"en/charts/bar-horizontal.md","lastUpdated":1724294638000}');
const _sfc_main = { name: "charts/bar-horizontal.md" };
const _hoisted_1 = /* @__PURE__ */ createBaseVNode("h1", {
  id: "horizontal-bar-chart",
  tabindex: "-1"
}, [
  /* @__PURE__ */ createTextVNode("Horizontal Bar Chart "),
  /* @__PURE__ */ createBaseVNode("a", {
    class: "header-anchor",
    href: "#horizontal-bar-chart",
    "aria-label": 'Permalink to "Horizontal Bar Chart"'
  }, "​")
], -1);
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", null, [
    ...
    createVNode(_component_demo, null, {
      component: withCtx(() => [
        createVNode(_component_bar_horizontal)
      ]),
      default: withCtx(() => [
        _hoisted_4
      ]),
    ...
    createVNode(_component_demo, null, {
      component: withCtx(() => [
        createVNode(_component_bar_horizontal_configured)
      ]),
      default: withCtx(() => [
        _hoisted_6
      ]),
...
const barHorizontal = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render]]);
export {
  __pageData,
  barHorizontal as default
};
